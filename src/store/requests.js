...
export const getFileData = (repoName, path, branch) => {
...
export const getGitTreeContent = (action, onLoader, name, branch, path) => {
    onLoader(true);
    ...
    return axios.get(origin + '/api/repos/' + name + '/tree/' + branch + filePath)
        .then(function (response) {
            ...
            action(_.sortBy(formatted, [function (o) { return !o.isFolder; }]));
        })
        .catch(function (error) {
            console.log(error);
            return [];
